 ...
 * for media query matches to Pesto view configurations.
 *
...
class MediaQueryObserver {
   ...
   * @constructor
   * @param {!Object} $window
   * @param {!Object} pestoViewConfigurations
   */
  constructor(pestoViewConfigurations, $rootScope, $window, $log) {
    ...
    this._subscribers = [ ];
    this._configurations = pestoViewConfigurations;
...
MediaQueryObserver.$inject = ['pestoViewConfigurations', '$rootScope', '$window', '$log'];
